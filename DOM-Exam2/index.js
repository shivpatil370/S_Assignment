...
form.addEventListener("submit",(event)=>{
    ...
    //   console.log(obj)
     ...
     if(check.length==0){ 
    axios.post("https://crudcrud.com/api/7bb65d43bf4c44529fb79fef889946c4/todos",obj)
    .then((res)=>{
    ...
    // console.log(check[0])
    axios.get(`https://crudcrud.com/api/7bb65d43bf4c44529fb79fef889946c4/todos/${check[0]}`)
    .then((res)=>{
        let editdata=(res.data);

        let name1=document.querySelector("#name").value;
        let rating1=document.querySelector("#rating").value;
        axios.put(`https://crudcrud.com/api/7bb65d43bf4c44529fb79fef889946c4/todos/${check[0]}`,{
            name:name1,
            rating:rating1,
...
ul.addEventListener("click",(e)=>{
    ...
    // DELETE BUTTON
    if(currentdel){
        axios.delete(`https://crudcrud.com/api/7bb65d43bf4c44529fb79fef889946c4/todos/${getid}`)
        .then((res)=>{
            // console.log(res)
            renderData()
    ...
    if(currentEdit){
        // console.log(getid)
        axios.get(`https://crudcrud.com/api/7bb65d43bf4c44529fb79fef889946c4/todos/${getid}`)
        .then((res)=>{
            let deta=res.data;
...
function renderData(){
     axios.get("https://crudcrud.com/api/7bb65d43bf4c44529fb79fef889946c4/todos")
            .then((res)=>{
                // console.log(res.data)
                MyFun(res.data);
